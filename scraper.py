...
# Funkcja do pobierania danych z Helion
def scrape_helion():
    try:
        url = 'https://helion.pl/'
        headers = {
        ...
        promotions = []
        # Szuka elementów z klasą product
...
# Funkcja do pobierania danych z Onepress
def scrape_onepress():
    try:
...
# Funkcja do pobierania danych z Ebookpoint
...
def main():
    ...
    print("📁 Plik promocje.json został zaktualizowany")
